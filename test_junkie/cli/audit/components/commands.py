...
def components(sources, suites, features, components, owners, tags, no_guess_root, verbose, no_features, no_owners,
    ...
    """Pivot test information from component's perspective"""
    if verbose:
    ...
    try:
        ...
        tj.scan()
        aggregator = CliAudit(suites=tj.suites, args=locals(), command="components")
